...
defmodule App do
  @map_layout %{
		"layout" => :_layout_a9ykpzxlyyuWlBlD,
  } #_MAP_LAYOUT

  @map_widget %{
		"app" => :_app_a9ykpNpjxmkPjba7,
  } #_MAP_WIDGET

  @map_page %{
		"404" => :_404_a9ykpdDXi3sPLFm8,
		"error" => :_error_a9ykpG7NMOjjU41F,
		"index" => :_index_a9ykpbJd39CCfyX2,
  } #_MAP_PAGE
...
defmodule LAYOUT do
	def _layout_a9ykpzxlyyuWlBlD(args, cont) do
